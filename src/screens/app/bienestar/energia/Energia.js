...
import { styles } from "./EnergiaStyles"
import { Card } from "../../../../components/card/Card"
import { useDbData } from '../../../../firebase/useDbData';

export  function Energia({ route }) {
  ...
  if(!data) return null; 
  const datosFiltrados = Object.values(data).filter((val) => val.ubicacion === 'energia');
      ...
      }
      {
        role === "admin" && (
          <View style={styles.viewBtn}>
            <Pressable style={styles.btnCrear} onPress={() => navigation.navigate( screen.inicio.video, { isEdit: false, videoInfo: null, ubicacion: "energia" } )}>
